...
from .forms import (BarsikLakshyaForm, UjuriGunasoForm, NamunaBibaranForm, PatraJariForm, PatraNabikaranForm,
                    ...
                    AnugamanEditForm,PragatiBibaranEditForm, KhadyaactEditForm,UjuriGunasoEditForm, 
                    HotelEditForm, KhadyaEditForm, PrayogsalaEditForm,RbpaEditForm,AayatNiryatEditForm,YearlyBudgetForm,QuarterelyBudgetForm,MonthlyExpenseForm,RajaswoForm)


from .models import (BarsikLakshya, AnugamanBibaran, NamunaBisleysan, AayatNiryat, PrayogsalaBisleysan, Logobitaran, UjuriGunaso,
                    ...
                    YearlyBudget,QuarterelyBudget,MonthlyExpense,Rajaswo,AarthikBarsa)
...
from .report_sum import (ayatniryat_sum, namunabibaran_sum, anugamanbibaran_sum, logobitaran_sum, namunabisleysan_sum, prayogsala_sum, 
                        ...
                        office_udyogsifaris_monthly_sum, office_ujurigunaso_monthly_sum, office_ayatniryat_monthly_sum,rbpa_quarterely_report )
...
#Global variables
aarthik_barsa= AarthikBarsa.objects.get(id=1).aarthik_barsa

@admin_required
def change_fiscal_year(request):
    return render(request,'aarthik_barsa.html')
def calculate_quarterly_value(month, quarter_dict):
    cumulative_sum = 0
...
def aayat(request):
    ...
    data = {
        'ekai': commons.EKAI_CHOICES,
        'month' :commons.MONTHS_CHOICES,
    }
    
    if request.method == 'POST':
        form = AayatNiryatForm(request.POST)
        if form.is_valid():
            related_month=int(request.POST.get('related_month',None))
            print(related_month)
            ...
            m_data = {
                ...
                'countries_count': form.cleaned_data.get('m_countries_count'),
                'countries_names': form.cleaned_data.get('m_countries_names'),
                'kaifiyat': form.cleaned_data.get('m_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **m_data))
            ...
            o_data = {
                ...
                'countries_count': form.cleaned_data.get('o_countries_count'),
                'countries_names': form.cleaned_data.get('o_countries_names'),
                'kaifiyat': form.cleaned_data.get('o_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **o_data))
            ...
            f_data = {
                ...
                'countries_count': form.cleaned_data.get('f_countries_count'),
                'countries_names': form.cleaned_data.get('f_countries_names'),
                'kaifiyat': form.cleaned_data.get('f_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **f_data))
            ...
            s_data = {
                ...
                'countries_count': form.cleaned_data.get('s_countries_count'),
                'countries_names': form.cleaned_data.get('s_countries_names'),
                'kaifiyat': form.cleaned_data.get('s_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **s_data))
            ...
            t_data = {
                ...
                'countries_count': form.cleaned_data.get('t_countries_count'),
                'countries_names': form.cleaned_data.get('t_countries_names'),
                'kaifiyat': form.cleaned_data.get('t_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **t_data))
            ...
            sa_data = {
                ...
                'countries_count': form.cleaned_data.get('countries_count'),
                'countries_names': form.cleaned_data.get('countries_names'),
                'kaifiyat': form.cleaned_data.get('sa_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **sa_data))
            ...
            k_data = {
                ...
                'countries_count': form.cleaned_data.get('k_countries_count'),
                'countries_names': form.cleaned_data.get('k_countries_names'),
                'kaifiyat': form.cleaned_data.get('k_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **k_data))
            ...
            w_data = {
                ...
                'countries_count': form.cleaned_data.get('w_countries_count'),
                'countries_names': form.cleaned_data.get('w_countries_names'),
                'kaifiyat': form.cleaned_data.get('w_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **w_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **sw_data))
            ...
            c_data = {
                ...
                'countries_count': form.cleaned_data.get('c_countries_count'),
                'countries_names': form.cleaned_data.get('c_countries_names'),
                'kaifiyat': form.cleaned_data.get('c_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **c_data))
            ...
            me_data = {
                ...
                'countries_count': form.cleaned_data.get('me_countries_count'),
                'countries_names': form.cleaned_data.get('me_countries_names'),
                'kaifiyat': form.cleaned_data.get('me_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **me_data))
            ...
            ot_data = {
                ...
                'countries_count': form.cleaned_data.get('ot_countries_count'),
                'countries_names': form.cleaned_data.get('ot_countries_names'),
                'kaifiyat': form.cleaned_data.get('ot_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **ot_data))
            ...
            g_data = {
                ...
                'countries_count': form.cleaned_data.get('g_countries_count'),
                'countries_names': form.cleaned_data.get('g_countries_names'),
                'kaifiyat': form.cleaned_data.get('g_kaifiyat'),
            }
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=1, **g_data))
    ...
    return render(request, 'forms/import-export/import.html', context)
...
def export(request): 
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **m_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **o_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **f_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **s_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **t_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **sa_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **k_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **w_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **sw_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **c_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **me_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **ot_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=2, **g_data))
    ...
    return render(request, 'forms/import-export/export.html', context)


def bhansar_chali_nikasi(request):
    data = {
        'ekai': commons.EKAI_CHOICES,
        'month' :commons.MONTHS_CHOICES,
    }
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **m_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **o_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **f_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **s_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **t_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **sa_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **k_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **w_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **sw_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **c_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **me_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **ot_data))
            ...
            objects_to_create.append(AayatNiryat(created_by=request.user,related_month=related_month,broad_type=3, **g_data))
    ...
    return render(request, 'forms/import-export/bhansar_chali.html', context)
...
def khadya_prasodhan(request):
    ...
    if request.method == 'POST':
        ...
        for miti, naam, sthan, m_sankhya, p_sankhya, nikaya, bisaya, kaifiyat in zip(
            k_miti, k_naam, k_sthan, k_m_sankhya, k_p_sankhya, k_nikaya, k_bisaya, k_kaifiyat):
...
def barsik_budget(request):
    if request.method == 'POST':
        form=YearlyBudgetForm(request.POST)
        if form.is_valid():
            try:
                YearlyBudget.objects.create(created_by=request.user,aarthik_barsa=aarthik_barsa,**form.cleaned_data)
                messages.success(request,"Form Submitted Successfully")
                return redirect('yearly-budget-report')
            except RecordAlreadyExists as e:
                messages.error(request,e.message)
                return redirect('barsik_budget')
        else:
             messages.error(request, "Please fill the form with correct data")
             return redirect('barsik_budget')
    else:
        ...
        return render(request,'forms/account/barsik_budget.html',context)
    

@ie_and_fo_and_do_and_account_required
def quarterely_budget(request):
    if request.method =='POST':
        form= QuarterelyBudgetForm(request.POST)
        if form.is_valid():
            try:
                QuarterelyBudget.objects.create(created_by=request.user,aarthik_barsa=aarthik_barsa,**form.cleaned_data,)
                messages.success(request,"Form submitted Successfully")
                return redirect("quarterely-budget-report")
            except RecordAlreadyExists as e:
                messages.error(request,"Record for this quarter already exists")
                return redirect('quarterely_budget')
        else:
            print(form.errors)
            messages.error(request,'Please fill the form with correct data')
            return redirect('quarterely_budget')
    else:
        quarters=commons.QUARTER_CHOICES
        form=QuarterelyBudgetForm()
        context={
            'form':form,
            'quarters':quarters,
        }
    return render(request,'forms/account/quarterely_budget.html',context)

@ie_and_fo_and_do_and_account_required
def masik_expense(request):
    if request.method =='POST':
        form= MonthlyExpenseForm(request.POST)
        if form.is_valid():
            try:
                MonthlyExpense.objects.create(created_by=request.user,aarthik_barsa=aarthik_barsa,**form.cleaned_data)
                messages.success(request,"Form submitted Successfully")
                return redirect('monthly-expense-report')
            except RecordAlreadyExists as e:
                messages.error(request,"Record for this quarter already exists")
                return redirect('masik_expense')
        else:
            print(form.errors)
            messages.error(request,'Please fill the form with correct data')
            return redirect('masik_expense')
        ...
        return render(request,'forms/account/masik_expense.html',context)

@ie_and_fo_and_do_and_account_required
def rajaswo(request):
    if request.method =='POST':
        form= RajaswoForm(request.POST)
        if form.is_valid():
            try:
                Rajaswo.objects.create(created_by=request.user,aarthik_barsa=aarthik_barsa,**form.cleaned_data)
                messages.success(request,"Form submitted Successfully")
                return redirect('monthly-rajaswo-report')
            except RecordAlreadyExists as e:
                messages.error(request,"Record for this quarter already exists")
                return redirect('quarterely_budget')
        else:
    ...
    return render(request,'forms/account/rajaswo.html',context)
...
def rbpa_fruits(request):
    ...
    if request.method == 'POST':
        ...
        d_country1 = request.POST.get('country1[]')
        d_sample1 = request.POST.get('sample1[]')
        d_quantity1 = request.POST.get('quantity1[]')
        d_sample2 = request.POST.get('sample2[]')
        d_quantity2 = request.POST.get('quantity2[]')
        d_country2 = request.POST.get('country2[]')
        d_sample3 = request.POST.get('sample3[]')
        d_quantity3 = request.POST.get('quantity3[]')
        d_country3 = request.POST.get('country3[]')
        ...
        form_data = {
            'date': d_date,
            'commodity1': d_country1,
            'sample1': d_sample1,
            'quantity1': d_quantity1,
            'sample2': d_sample2,
            'quantity2': d_quantity2,
            'commodity2': d_country2,
            'sample3': d_sample3,
            'quantity3': d_quantity3,
            'commodity3': d_country3,
        }
        form = DetailRbpaForm(form_data)
        if form.is_valid():
            objects_to_create.append(DetailRbpa(created_by=request.user,related_month=related_month,broad_type=1, **form.cleaned_data))
        else:
            messages.error(request, "Please fill the form with correct data")
            print(form.errors)
            return redirect('d-rbpa-fruits')
        try:
    ...
    return render(request, 'forms/details/rbpa_fruits.html', context)

def rbpa_vegetables(request):
    """views for detail RBPA Analysis"""
    months=commons.MONTHS_CHOICES
    ...
    if request.method == 'POST':
        ...
        form = DetailRbpaForm(form_data)
        if form.is_valid():
            objects_to_create.append(DetailRbpa(created_by=request.user,related_month=related_month,broad_type=2, **form.cleaned_data))
        else:
            messages.error(request, "Please fill the form with correct data")
            return redirect('d-rbpa-vegetables')
        try:
            DetailRbpa.objects.bulk_create(objects_to_create)    
            messages.success(request, "Form submitted successfully")
            return redirect('rbpa-report')
    ...
    return render(request, 'forms/details/rbpa_vegetables.html', context)
...
def rbpa_report(request):
     ...
     month=[]
     latest_related_month=DetailRbpa.objects.latest('created_on')
     month1 = (request.GET.get('month_value', latest_related_month.related_month))
     month.append(month1)
     traimasik=request.GET.get('traimasik')
     total_sum = rbpa_monthly_sum(request,month1)
     if traimasik:
         traimasik=int(traimasik)
         total_sum=rbpa_quarterely_report(request,traimasik)
         month=commons.quarter_dict[traimasik]
     # print(quarter_sum)
     user_office = CustomUser.objects.filter(office=request.user.office)
     if request.user.role == 'A':
         data = DetailRbpa.objects.filter(
                                        related_month=month)
     elif request.user.role == 'V':
         data = DetailRbpa.objects.all()
     else:
         data = DetailRbpa.objects.filter(created_by__in=user_office,
                                        related_month__in=month)
     context = {'data': data, 
             'total_sum': total_sum
             }
...
def finance_view(request, id):
    obj = get_object_or_404(YearlyBudget, id=id)
    context = {'obj': obj}
    return render(request, 'detail/finance_detail.html', context)


# def finance_edit(request, id):
#     finance_object = get_object_or_404(Budget, id=id)
#     if request.method == 'POST':
...
def yearly_budget(request):
    ...
    if request.user.role == 'A' or request.user.role == 'V':
        data = YearlyBudget.objects.filter(aarthik_barsa=aarthik_barsa)
    else:
        data = YearlyBudget.objects.filter(created_by__in=user_office,aarthik_barsa=aarthik_barsa)
    context = {'data': data}
    return render(request, 'report/finance/yearly_budget.html', context)

@login_required
def quarterely_budget_report(request):
    user_office = CustomUser.objects.filter(office=request.user.office)
    if request.user.role == 'A' or request.user.role == 'V':
        data = QuarterelyBudget.objects.filter(aarthik_barsa=aarthik_barsa)
    else:
        data = QuarterelyBudget.objects.filter(created_by__in=user_office,aarthik_barsa=aarthik_barsa)
    context = {'data': data}
    return render(request, 'report/finance/quarterely_budget_report.html', context)

@login_required
def monthly_expense_report(request):
    user_office = CustomUser.objects.filter(office=request.user.office)
    if request.user.role == 'A' or request.user.role == 'V':
        data = MonthlyExpense.objects.filter(aarthik_barsa=aarthik_barsa)
    else:
        data = MonthlyExpense.objects.filter(created_by__in=user_office,aarthik_barsa=aarthik_barsa)
    context = {'data': data}
    return render(request, 'report/finance/monthly_expense_report.html', context)

@login_required
def quarterely_expense_report(request):
    user_office = CustomUser.objects.filter(office=request.user.office)
    quarters = {
    'Q1': [4, 5, 6],
    'Q2': [7, 8, 9],
...
# Initialize a dictionary to store the total expenses for each quarter
    quarter_totals = {}

# Loop through each quarter and its corresponding months
    for quarter, months in quarters.items():
    # Aggregate total expenses for the current quarter and its months
        total_expense = MonthlyExpense.objects.filter(
            aarthik_barsa=aarthik_barsa,
            month_or_quarter__in=months,
        ).aggregate(
            total_pujigat=Sum('pujigat'),
            total_chalugat=Sum('chalugat'),
            total=Sum('pujigat') + Sum('chalugat'),
    )

        # Store the total expenses in the dictionary for the current quarter
        quarter_totals[quarter] = total_expense
    

    context = {'quarter_totals': quarter_totals,
               'aarthik_barsa': aarthik_barsa
               }
    return render(request, 'report/finance/quarterely_expense_report.html',context)


@login_required
def yearly_expense_report(request):
    user_office = CustomUser.objects.filter(office=request.user.office)
    obj= MonthlyExpense.objects.filter(aarthik_barsa=aarthik_barsa).first()
    if request.user.role == 'A' or request.user.role == 'V':
        total_expense= MonthlyExpense.objects.filter(aarthik_barsa=aarthik_barsa).aggregate(
        total_pujigat=Sum('pujigat'),
        total_chalugat=Sum('chalugat'),
        total=Sum('pujigat')+Sum('chalugat'))
    else:
        total_expense= MonthlyExpense.objects.filter(aarthik_barsa=aarthik_barsa,created_by__in=user_office).aggregate(
            total_pujigat=Sum('pujigat'),
            total_chalugat=Sum('chalugat'),
            total=Sum('pujigat')+Sum('chalugat'))
    context={
        'office':obj.created_by.office.name,
        'aarthik_barsa':aarthik_barsa,
        'total_expense':total_expense,
    }
    return render(request,'report/finance/yearly_expense_report.html',context)

@login_required
def monthly_rajaswo_report(request):
    user_office = CustomUser.objects.filter(office=request.user.office)
    if request.user.role == 'A' or request.user.role == 'V':
        data = Rajaswo.objects.filter(aarthik_barsa=aarthik_barsa)
    else:
        data = Rajaswo.objects.filter(created_by__in=user_office,aarthik_barsa=aarthik_barsa)
    context = {'data': data}
    return render(request, 'report/finance/monthly_rajaswo_report.html', context)

@login_required
def quarterely_rajaswo_report(request):
    user_office = CustomUser.objects.filter(office=request.user.office)
    quarters = {
    'Q1': [4, 5, 6],
    'Q2': [7, 8, 9],
...
# Loop through each quarter and its corresponding months
    for quarter, months in quarters.items():
    # Aggregate total expenses for the current quarter and its months
        total_expense = Rajaswo.objects.filter(
            aarthik_barsa=aarthik_barsa,
            month_or_quarter__in=months,
        ).aggregate(
            total=Sum('rajaswo_collected'),
    )
    ...
    return render(request, 'report/finance/quarterely_rajaswo_report.html',context)


@login_required
def yearly_rajaswo_report(request):
    user_office = CustomUser.objects.filter(office=request.user.office)
    obj= Rajaswo.objects.filter(aarthik_barsa=aarthik_barsa).first()
    if request.user.role == 'A' or request.user.role == 'V':
        total_expense= Rajaswo.objects.filter(aarthik_barsa=aarthik_barsa).aggregate(
        total=Sum('rajaswo_collected'))
    else:
        total_expense= Rajaswo.objects.filter(aarthik_barsa=aarthik_barsa,created_by__in=user_office).aggregate(
            total=Sum('rajaswo_collected'))
    context={
        'office':obj.created_by.office.name,
        'aarthik_barsa':aarthik_barsa,
    ...
    return render(request,'report/finance/yearly_rajaswo_report.html',context)
@login_required
