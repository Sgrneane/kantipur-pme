...
from .models import (BarsikLakshya, NamunaBibaran, PatraJari, PatraNabikaran, UdyogSifaris, UjuriGunaso, AnugamanBibaran,
                    NamunaBisleysan, AayatNiryat, PrayogsalaBisleysan, Logobitaran, KhadyaPrasodhan, PragatiBibaran,
                    DetailHotel, DetailRegistration, DetailRenew, DetailUdyog, DetailAnugaman, DetailGunaso, DetailMudha, DetailRbpa,AarthikBarsa)
...
admin.site.register(AarthikBarsa)
