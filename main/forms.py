...
from .models import (UjuriGunaso, NamunaBibaran, PatraJari, PatraNabikaran, UdyogSifaris, PrayogsalaBisleysan,
                    KhadyaPrasodhan, DetailAnugaman, DetailHotel, DetailRegistration, DetailRenew, DetailUdyog, BarsikLakshya,
                    DetailGunaso,KhadyaPrasodhan,UjuriGunaso, DetailMudha, DetailRbpa, PragatiBibaran, AnugamanBibaran, Logobitaran, NamunaBisleysan,AayatNiryat,YearlyBudget,QuarterelyBudget,MonthlyExpense,Rajaswo)
...
#         exclude = ["created_by",'budget_type','time_type']

class YearlyBudgetForm(BaseModelForm):
    class Meta:
        model= YearlyBudget
        exclude=["created_by",'aarthik_barsa']
    
class QuarterelyBudgetForm(BaseModelForm):
    class Meta:
        model= QuarterelyBudget
        exclude=["created_by",'aarthik_barsa']

class MonthlyExpenseForm(BaseModelForm):
    class Meta:
        model= MonthlyExpense
        exclude=['created_by','aarthik_barsa']
class RajaswoForm(BaseModelForm):
    class Meta:
        model= Rajaswo
        exclude=["created_by",'aarthik_barsa']
...
class AayatNiryatForm(forms.Form):
    ...
    m_countries_count = forms.IntegerField(required=False)
    m_countries_names = forms.CharField(required=False,max_length=2000)
    m_kaifiyat = forms.CharField(required=False)
    ...
    o_countries_count = forms.IntegerField(required=False)
    o_countries_names = forms.CharField(required=False,max_length=1000)
    o_kaifiyat = forms.CharField(required=False)
    ...
    f_countries_count = forms.IntegerField(required=False)
    f_countries_names = forms.CharField(required=False,max_length=2000)
    f_kaifiyat = forms.CharField(required=False)
    ...
    s_countries_count= forms.IntegerField(required=False)
    s_countries_names = forms.CharField(required=False,max_length=20000)
    s_kaifiyat = forms.CharField(required=False)
    ...
    t_countries_count = forms.IntegerField(required=False)
    t_countries_names = forms.CharField(required=False,max_length=1000)
    t_kaifiyat = forms.CharField(required=False)
    ...
    sa_countries_count = forms.IntegerField(required=False)
    sa_countries_names = forms.CharField(required=False,max_length=1000)
    sa_kaifiyat = forms.CharField(required=False)
    ...
    k_countries_count = forms.IntegerField(required=False)
    k_countries_names = forms.CharField(required=False,max_length=1000)
    k_kaifiyat = forms.CharField(required=False)
    ...
    w_countries_count = forms.IntegerField(required=False)
    w_countries_names = forms.CharField(required=False,max_length=1000)
    w_kaifiyat = forms.CharField(required=False)
    ...
    sw_countries_count = forms.IntegerField(required=False)
    sw_countries_names = forms.CharField(required=False,max_length=1000)
    sw_kaifiyat = forms.CharField(required=False)
    ...
    c_countries_count = forms.IntegerField(required=False)
    c_countries_names = forms.CharField(required=False,max_length=1000)
    c_kaifiyat = forms.CharField(required=False)
    ...
    me_countries_count = forms.IntegerField(required=False)
    me_countries_names = forms.IntegerField(required=False)
    me_kaifiyat = forms.CharField(required=False)
    ...
    ot_countries_count = forms.IntegerField(required=False)
    ot_countries_names = forms.CharField(required=False)
    ot_kaifiyat = forms.CharField(required=False)
    ...
    g_countries_names = forms.IntegerField(required=False)
    g_countries_name = forms.IntegerField(required=False)
    g_kaifiyat = forms.CharField(required=False)
    
    def clean(self):
        cleaned_data = super().clean()
        label = [
            'm_m_pragati', 'm_pratikul_n', 'm_pratikul_p',
            'o_m_pragati', 'o_pratikul_n', 'o_pratikul_p',
            'f_m_pragati', 'f_pratikul_n', 'f_pratikul_p',
            's_m_pragati', 's_pratikul_n', 's_pratikul_p',
            't_m_pragati', 't_pratikul_n', 't_pratikul_p',
            'sa_m_pragati', 'sa_pratikul_n', 'sa_pratikul_p',
            'k_m_pragati', 'k_pratikul_n', 'k_pratikul_p',
            'w_m_pragati', 'w_pratikul_n', 'w_pratikul_p',
            'sw_m_pragati', 'sw_pratikul_n', 'sw_pratikul_p',
            'c_m_pragati', 'c_pratikul_n', 'c_pratikul_p',
            'me_m_pragati', 'me_pratikul_n', 'me_pratikul_p',
            'ot_m_pragati', 'ot_pratikul_n', 'ot_pratikul_p',
            'g_m_pragati', 'g_pratikul_n', 'g_pratikul_p',
        ]
        for field_name in label:
            if field_name in cleaned_data and cleaned_data[field_name] is None:
                cleaned_data[field_name] = 0
...
class DetailRbpaForm(BaseModelForm):
    class Meta:
        model = DetailRbpa
        exclude = ["created_by",'broad_type','related_month']    
